...
void Option::setBaseCurrencyID ( const int base_currency_id )
{
...
void Option::setHideReport ( const int report, const bool value )
{
...
bool Option::getHideReport ( const int report ) const
{
...
const wxString Option::getReportFullName ( const int reportID ) const
{
    wxString name = "";
