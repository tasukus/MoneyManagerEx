...
public:
    enum RATE
    {
        RATE_NONE = 0, RATE_APPRECIATE, RATE_DEPRECIATE, RATE_UNKNOWN = -1
    };
    enum TYPE
    {
        TYPE_PROPERTY = 0, TYPE_AUTO, TYPE_HOUSE, TYPE_ART, TYPE_JEWELLERY, TYPE_CASH, TYPE_OTHER, TYPE_UNKNOWN = -1
    };
