...
struct DB_Table_CURRENCYFORMATS : public DB_Table
{
    ...
    void ensure_data ( wxSQLite3Database *db )
    {
        ...
        db->ExecuteUpdate ( wxString::Format ( "INSERT INTO CURRENCYFORMATS VALUES ('182', '%s', '', '', '.', ',', '100', 'CHC', 'Fiat', '1')",
                                               wxTRANSLATE ( "WIR Franc (for electronic) (before 2004-11)" ) ) );
        ...
        db->ExecuteUpdate ( wxString::Format ( "INSERT INTO CURRENCYFORMATS VALUES ('192', '%s', '', '', '.', ',', '100', 'ECV', 'Fiat', '1')",
                                               wxTRANSLATE ( "Unidad de Valor Constante (UVC) (before 2000-09)" ) ) );
        ...
        db->ExecuteUpdate ( wxString::Format ( "INSERT INTO CURRENCYFORMATS VALUES ('217', '%s', '', '', '.', ',', '100', 'LUC', 'Fiat', '1')",
                                               wxTRANSLATE ( "Luxembourg Convertible Franc (before 1990-03)" ) ) );
        ...
        db->ExecuteUpdate ( wxString::Format ( "INSERT INTO CURRENCYFORMATS VALUES ('219', '%s', '', '', '.', ',', '100', 'LUL', 'Fiat', '1')",
                                               wxTRANSLATE ( "Luxembourg Financial Franc (before 1990-03)" ) ) );
        ...
        db->ExecuteUpdate ( wxString::Format ( "INSERT INTO CURRENCYFORMATS VALUES ('264', '%s', '', '', '.', ',', '100', 'XEU', 'Fiat', '1')",
                                               wxTRANSLATE ( "European Currency Unit (E.C.U) (before 1999-01)" ) ) );
