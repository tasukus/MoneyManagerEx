...
struct DB_Table_CURRENCYHISTORY : public DB_Table
{
    ...
    struct Data
    {
        ...
        bool match ( const Self::CURRHISTID &in ) const noexcept
        {
        ...
        bool match ( const Self::CURRVALUE &in ) const noexcept
        {
            return this->CURRVALUE == in.v_;
        }

        bool match ( const Self::CURRUPDTYPE &in ) const noexcept
        {
